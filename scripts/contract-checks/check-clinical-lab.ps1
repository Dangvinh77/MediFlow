...
try {
    & mvn -q -pl backend/clinical-service,backend/lab-service,backend/billing-service,backend/pharmacy-service -am test dependency:build-classpath '-Dmdep.outputFile=target/wire-classpath.txt'
    ...
    $classDirectories = @(
        ...
        'backend/pharmacy-service/target/classes',
