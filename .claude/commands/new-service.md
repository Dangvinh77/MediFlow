...
Do this:
1. Read `docs/ai/04-microservice-blueprint.md` and `docs/ai/services/$ARGUMENTS.md` (if it exists). If no service doc exists, ask the user which design doc in `docs/eproject_general_plan/*.html` this maps to.
