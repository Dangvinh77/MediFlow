...
/**
 * JPA entity của bảng {@code PROCESSED_EVENT} — sổ chống xử lý trùng. Khi RabbitMQ gửi lại cùng
 * một message, {@code eventId} có mặt ở đây cho biết đã xử lý rồi để consumer bỏ qua (BR-B6/BR-B7).
 *
