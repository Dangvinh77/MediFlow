...
class JwtAuthFilterTest {
    ...
    void expiredToken_leavesRequestUnauthenticated() throws Exception {
        String token = createToken("admin-01", "ADMIN", SIGNING_KEY, Instant.now().minusSeconds(60));
    ...
    void invalidSignature_leavesRequestUnauthenticated() throws Exception {
        ...
        String token = createToken("admin-01", "ADMIN", otherKey, Instant.now().plusSeconds(300));
