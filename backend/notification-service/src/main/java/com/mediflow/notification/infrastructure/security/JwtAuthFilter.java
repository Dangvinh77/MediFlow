 ...
 *
 * <p>Principal xác thực xong là {@code sub} (dạng chuỗi UUID). Với vai trò {@code PATIENT},
 * {@code sub} chính là {@code patientId} của người gọi — hệ thống không phát hành một claim
 * {@code patientId} riêng (docs/ai/07-security-rbac.md); {@code NotificationController} dùng giá
 * trị này để kiểm tra quyền sở hữu BR-N6, không bao giờ lấy từ tham số request.
 */
