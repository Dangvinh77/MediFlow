...
contract. Before editing a feature or route, read its detailed guide in
[`docs/services/`](docs/services/README.md). The workboard is the current route-state pointer; do
not copy its matrix here.
